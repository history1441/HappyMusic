...
/**
 * 桥接桌面小组件与 RN:
 *  - 实现 ActivityEventListener 捕获 widget 按钮经 MainActivity.onNewIntent 传递的 widget_action,emit "WidgetControl"
 *  - getInitialAction() 处理冷启动(getIntent),updateWidget() 反向刷新小组件
 */
